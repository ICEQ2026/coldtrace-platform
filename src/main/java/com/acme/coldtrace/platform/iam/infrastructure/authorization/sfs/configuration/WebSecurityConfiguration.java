package com.acme.coldtrace.platform.iam.infrastructure.authorization.sfs.configuration;

import com.acme.coldtrace.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.acme.coldtrace.platform.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/organization-sign-ups").permitAll()
