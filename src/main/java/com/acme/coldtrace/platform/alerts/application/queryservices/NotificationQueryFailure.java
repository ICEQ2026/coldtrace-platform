...
/**
 * Failure types for notification query execution.
 *
 * @since 1.0
 */
public sealed interface NotificationQueryFailure
        permits NotificationQueryFailure.OrganizationNotFound, NotificationQueryFailure.IncidentNotFound {
    ...
    record OrganizationNotFound() implements NotificationQueryFailure {
        @Override
    ...
    record IncidentNotFound() implements NotificationQueryFailure {
        @Override
        public String messageKey() {
